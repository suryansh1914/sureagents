...
If you use plan mode and deny plans, you already have the data. The skill reads it and puts it to work. It works day one for any Claude Code user who has been actively using plan mode. [SureAgents](https://github.com/suryansh1914/sureagents) users get an even richer analysis since SureAgents captures full plan text and inline annotations with every denial. SureAgents is [open source](https://github.com/suryansh1914/sureagents) and free.

[Install SureAgents](https://github.com/suryansh1914/sureagents?tab=readme-ov-file#install-for-claude-code), then run:
...
When you deny a plan in Claude Code, that interaction gets logged. If you're a SureAgents user, it's even better. The more you use it, the richer your archive gets. Full plan text, inline annotations, structural feedback, all saved as markdown files that build up over time.
...
SureAgents users get the richest analysis since the archive contains full plan text and inline annotations. But you don't need SureAgents.
...
If you have [SureAgents](https://github.com/suryansh1914/sureagents) installed, it works out of the box. If you're using Claude Code without SureAgents, the skill works with your existing session logs, no additional setup.

The more denial history you have, the richer the analysis. Start with the [installation guide](/docs/getting-started/installation/) or check out the [repo](https://github.com/suryansh1914/sureagents).
