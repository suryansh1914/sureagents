---
title: "Self-Hosting"
description: "Deploy and self-host the full SureAgents system — hook, share portal, and paste service."
sidebar:
  order: 23
section: "Guides"
---

SureAgents has three components. Only the hook is required.
...
Download the paste service binary for your platform from [GitHub Releases](https://github.com/suryansh1914/sureagents/releases). Binaries are available for macOS (ARM64, x64), Linux (x64, ARM64), and Windows (x64).

```bash
chmod +x sureagents-paste-*
./sureagents-paste-darwin-arm64   # or whichever matches your platform
```

Pastes stored to `~/.sureagents/pastes/` by default.
...
| `PASTE_DATA_DIR` | `~/.sureagents/pastes` | Storage directory |
...
```bash
export SUREAGENTS_SHARE_URL=https://your-portal.example.com
export SUREAGENTS_PASTE_URL=https://your-paste.example.com
```
