/**
 * Core types for the SureAgents AI provider layer.
 *
 ...
 * power AI features inside SureAgents's plan review and code review UIs.
 */
...
/**
 * An AI provider implements the bridge between SureAgents and a specific
...
export interface AIProvider {
   ...
   * receives the SureAgents review context. This enables the user to
  ...
  /**
   * Resume a previously created SureAgents AI session by its ID.
