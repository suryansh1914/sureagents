...
} from "@sureagents/shared/integrations-common";
import { resolveUserPath } from "@sureagents/shared/resolve-file";
...
export async function saveToObsidian(
	...
	try {
		...
		const folderName = folder.trim() || "sureagents";
...
export async function saveToOctarine(
	...
	try {
		...
		const folder = config.folder.trim() || "sureagents";
