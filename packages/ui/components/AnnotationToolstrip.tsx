...
export const AnnotationToolstrip: React.FC<AnnotationToolstripProps> = ({
  ...
  const [helpTab, setHelpTab] = useState<'selection' | 'sureagents'>('selection');
          ...
          >
            ...
            <div className="aspect-video">
              <iframe
                ...
                title={helpTab === 'selection' ? 'How Selection Modes Work' : 'How SureAgents Works'}
                frameBorder="0"
