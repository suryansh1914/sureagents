...
const STORAGE_KEY_ENABLED = 'sureagents-bear-enabled';
const STORAGE_KEY_CUSTOM_TAGS = 'sureagents-bear-custom-tags';
const STORAGE_KEY_TAG_POSITION = 'sureagents-bear-tag-position';
const STORAGE_KEY_AUTOSAVE = 'sureagents-bear-autosave';
