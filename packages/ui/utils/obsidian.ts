...
// Storage keys
const STORAGE_KEY_ENABLED = 'sureagents-obsidian-enabled';
const STORAGE_KEY_VAULT = 'sureagents-obsidian-vault';
const STORAGE_KEY_FOLDER = 'sureagents-obsidian-folder';
const STORAGE_KEY_CUSTOM_PATH = 'sureagents-obsidian-custom-path';
const STORAGE_KEY_FILENAME_FORMAT = 'sureagents-obsidian-filename-format';
const STORAGE_KEY_VAULT_BROWSER = 'sureagents-obsidian-vault-browser';
const STORAGE_KEY_AUTOSAVE = 'sureagents-obsidian-autosave';
const STORAGE_KEY_FILENAME_SEPARATOR = 'sureagents-obsidian-filename-separator';

// Sentinel value for custom path selection
export const CUSTOM_PATH_SENTINEL = '__custom__';

// Default folder name in the vault
const DEFAULT_FOLDER = 'sureagents';
...
export function extractTags(markdown: string): string[] {
  const tags = new Set<string>(['sureagents']);
