...
const STORAGE_KEY = 'sureagents-quick-labels';
...
export const DEFAULT_QUICK_LABELS: QuickLabel[] = [
  ...
  { id: 'consider-alternatives',    emoji: '🔄', text: 'Consider alternatives',    color: 'pink', tip: 'Propose 2-3 alternative approaches with trade-offs based on the actual codebase. Also check the SureAgents plans directory (SUREAGENTS_DATA_DIR or ~/.sureagents/plans/) for prior plan versions that may have already explored or rejected similar approaches.' },
