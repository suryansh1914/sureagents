---
name: sureagents-last
description: Open SureAgents on the latest rendered assistant message and use the returned annotations to revise that message or continue.
disable-model-invocation: true
---

# SureAgents Last

Use this skill when the user wants to annotate the latest assistant response in SureAgents.
