/**
 * Context builders — translate SureAgents review state into system prompts
 ...
 * - That it's operating inside SureAgents (not a general coding session)
 */
 ...
 * short "you are now in SureAgents" preamble with the relevant content.
 */
export function buildForkPreamble(ctx: AIContext): string {
  const lines: string[] = [
    "The user is now reviewing your work in SureAgents and has a question.",
...
function buildPlanReviewPrompt(
  ...
  const sections: string[] = [
    "The user is reviewing an implementation plan in SureAgents.",
    "",
    "## Plan Under Review",
  ];
...
function buildCodeReviewPrompt(
  ...
  const sections: string[] = [
    "The user is reviewing a code diff in SureAgents.",
  ];
...
function buildAnnotatePrompt(
  ...
  const sections: string[] = [
    "The user is annotating a markdown document in SureAgents.",
    "",
