/**
 * @sureagents/ai — AI provider layer for SureAgents.
 *
 * This package provides the backbone for AI-powered features (inline chat,
 * plan Q&A, code review assistance) across all SureAgents surfaces.
 *
 * Architecture:
 *
 *   ┌─────────────────┐     ┌──────────────┐
 ...
 *
 * ```ts
 * import "@sureagents/ai/providers/claude-agent-sdk";
 * import { ProviderRegistry, createProvider, createAIEndpoints, SessionManager } from "@sureagents/ai";
 *
