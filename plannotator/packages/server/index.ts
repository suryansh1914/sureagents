 ...
 *   SUREAGENTS_ORIGIN - Explicit origin override; validated against AGENT_CONFIG
...
import { readImprovementHook, getImprovementHookExpectedPath } from "@sureagents/shared/improvement-hooks";
...
import { warmFileListCache } from "@sureagents/shared/resolve-file";
...
export { type VaultNode, buildFileTree } from "@sureagents/shared/reference-common";
 ...
 */
export async function startSureAgentsServer(
    ...
    try {
      server = Bun.serve({
        ...
        async fetch(req, server) {
          ...
          // API: List archived plans (from ~/.sureagents/plans/)
