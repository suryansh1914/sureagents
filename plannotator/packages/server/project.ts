 ...
 *
 * Pure string functions re-exported from @sureagents/shared/project.
 * detectProjectName() is Bun-specific (uses Bun.$).
 */

import { $ } from "bun";
import { extractRepoName, extractDirName } from "@sureagents/shared/project";
export { sanitizeTag, extractRepoName, extractDirName } from "@sureagents/shared/project";
