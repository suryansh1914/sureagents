...
export const Settings: React.FC<SettingsProps> = ({ taterMode, onTaterModeChange, onIdentityChange, origin, mode = 'plan', onUIPreferencesChange, externalOpen, onExternalClose, aiProviders = [], gitUser }) => {
  ...
  const [octarine, setOctarine] = useState<OctarineSettings>({ enabled: false, workspace: '', folder: 'sureagents', autoSave: false });
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="text-[10px] text-muted-foreground/70">
                            Plans saved to: {obsidian.vaultPath === CUSTOM_PATH_SENTINEL
                              ? (obsidian.customPath || '...')
                              : (obsidian.vaultPath || '...')}/{obsidian.folder || 'sureagents'}/
                          </div>
                  ...
                  <>
                    ...
                    {octarine.enabled && (
                      <div className="mt-3 space-y-3">
                        ...
                        <div className="text-[10px] text-muted-foreground/70">
                          Plans saved to: {octarine.workspace || '...'} / {octarine.folder || 'sureagents'}/
                        </div>
