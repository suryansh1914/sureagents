...
const IS_VSCODE = typeof window !== 'undefined' && (window as any).__SUREAGENTS_VSCODE === true;
 ...
 * window.__SUREAGENTS_VSCODE set by the theme bridge). In browser/shared URL
