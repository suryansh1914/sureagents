...
describe("normalizeTags", () => {
  ...
  test("preserves slashes for Bear nested tags", () => {
    expect(normalizeTags("sureagents/plans")).toBe("sureagents/plans");
  });
  ...
  test("mixed nested and flat tags", () => {
    expect(normalizeTags("sureagents/plans, work, code/review")).toBe("sureagents/plans, work, code/review");
  });
