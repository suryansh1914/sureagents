...
const STORAGE_KEY_ENABLED = 'sureagents-octarine-enabled';
const STORAGE_KEY_WORKSPACE = 'sureagents-octarine-workspace';
const STORAGE_KEY_FOLDER = 'sureagents-octarine-folder';
const STORAGE_KEY_AUTOSAVE = 'sureagents-octarine-autosave';
...
export function getOctarineSettings(): OctarineSettings {
  return {
    ...
    folder: storage.getItem(STORAGE_KEY_FOLDER) || 'sureagents',
