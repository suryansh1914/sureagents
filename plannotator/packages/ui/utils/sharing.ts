/**
 * Portable sharing utilities for SureAgents
 *
...
import { compress, decompress } from '@sureagents/shared/compress';
import { encrypt, decrypt } from '@sureagents/shared/crypto';
...
const DEFAULT_PASTE_API = 'https://sureagents-paste.sureagents.workers.dev';
...
export async function createShortShareUrl(
  ...
  globalAttachments?: ImageAttachment[],
  options?: {
    /** Override the paste API base URL (default: https://sureagents-paste.sureagents.workers.dev) */
    pasteApiUrl?: string;
