...
const STORAGE_KEY_TOC = 'sureagents-toc-enabled';
const STORAGE_KEY_STICKY_ACTIONS = 'sureagents-sticky-actions-enabled';
const STORAGE_KEY_PLAN_WIDTH = 'sureagents-plan-width';
