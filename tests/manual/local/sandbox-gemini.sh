...
echo "=== SureAgents Gemini Sandbox ==="
echo ""
...
cp "$PROJECT_ROOT/apps/gemini/hooks/sureagents.toml" "$GEMINI_DIR/policies/sureagents.toml"
...
if [ "$MODE" = "--simulate" ]; then
    ...
    PLAN_FILE=$(mktemp /tmp/sureagents-test-XXXXX.md)
...
echo "  3. When exit_plan_mode fires, your browser should open with SureAgents"
