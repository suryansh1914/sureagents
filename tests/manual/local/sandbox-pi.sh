#!/bin/bash
# Sandbox script for testing SureAgents Pi extension locally
#
# Usage:
...
#   - Code review: Run /sureagents-review
#   - Annotate file: Run /sureagents-annotate README.md
#   - Annotate last: Run /sureagents-last
...
This is a sandbox for testing the SureAgents Pi extension.
...
if [ "$NO_GIT" = false ]; then
  ...
  # Add uncommitted changes (for /sureagents-review)
  cat >> src/index.ts << 'EOF'
...
if [ "$NO_GIT" = false ]; then
  echo "  2. Code review: Run /sureagents-review"
fi
echo "  3. Annotate file: Run /sureagents-annotate README.md"
echo "  4. Annotate last: Run /sureagents-last"
echo ""
echo "Launching Pi..."
echo ""
